...
function Account(){
    ...
    const [isLogged,setLogged] = useState(false);              //хук для состояния входа
    ...
    const handleButtonClick = () => {
        ...
        setLogged(validationResult.emailBool
            && validationResult.passwordBool); //проверяем логин и пароль
        }
